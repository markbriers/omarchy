...
- **Nothing has been run on real hardware yet.** The dry run, the detection
  and the gating are covered by tests; a full install has not been executed on
  a Pi 5, a Mac or a VM.
