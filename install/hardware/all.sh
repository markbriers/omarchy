...
# Gated to x86_64: the DKMS build against linux-aarch64 is unmeasured, and
# the ARM targets have no Cam Link attached.
run_logged_x86 "$OMARCHY_INSTALL/hardware/fix-elgato-camlink-4k.sh"
...
run_logged_x86 "$OMARCHY_INSTALL/hardware/dell-xps13-sidecar-amps.sh"
